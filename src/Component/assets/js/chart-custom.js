...
!(function (e) {
      ...
      series: [
        {
          name: "Male",
          data: [
            -2.2, -2.1, -2.2, -2.4, -2.7, -3, -3.3, -3.2, -2.9, -3.5, -4.4,
            -4.1, -0,
          ],
          color: "#827af3",
        },
  ...
  const $tableID = $("#table"),
    ...
    $EXPORT = $("#export"),
    newTr =
      '\n<tr className="hide">\n  <td className="pt-3-half" contenteditable="true">Example</td>\n  <td className="pt-3-half" contenteditable="true">Example</td>\n  <td className="pt-3-half" contenteditable="true">Example</td>\n  <td className="pt-3-half" contenteditable="true">Example</td>\n  <td className="pt-3-half" contenteditable="true">Example</td>\n  <td className="pt-3-half">\n    <span className="table-up"><a href="#!" className="indigo-text"><i className="fas fa-long-arrow-alt-up" aria-hidden="true"></i></a></span>\n    <span className="table-down"><a href="#!" className="indigo-text"><i className="fas fa-long-arrow-alt-down" aria-hidden="true"></i></a></span>\n  </td>\n  <td>\n    <span className="table-remove"><button type="button" className="btn btn-danger btn-rounded btn-sm my-0 waves-effect waves-light">Remove</button></span>\n  </td>\n</tr>';
  ...
  if (jQuery("#menu-chart-03").length) {
    ...
    var chart = new ApexCharts(
      document.querySelector("#menu-chart-03"),
      options
    );
    chart.render();
    const body = document.querySelector("body");
  ...
  if (jQuery("#menu-chart-02").length) {
    ...
    var chart = new ApexCharts(
      document.querySelector("#menu-chart-02"),
      options
    );
    chart.render();
    const body = document.querySelector("body");
